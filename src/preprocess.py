...
RATING_FILE_NAME = dict({'movie': 'ratings.csv', 'book': 'user_contacts.dat', 'music': 'user_artists.dat'})
...
def convert_rating():
    ...
    writer = open('../data/' + DATASET + '/ratings_final.txt', 'w')
    user_cnt = 0
...
def convert_kg():
    ...
    writer = open('../data/' + DATASET + '/kg_final.txt', 'w')
    for line in open('../data/' + DATASET + '/kg.txt'):
